...
<html>
    ...
    <body>
        ...
        <div id="edit-estoque" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.estoque}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.estoque}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.estoque}" method="PUT">
                <g:hiddenField name="version" value="${this.estoque?.version}" />
                <fieldset class="form">
                    <f:all bean="estoque"/>
                </fieldset>
