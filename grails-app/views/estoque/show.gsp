...
<html>
    ...
    <body>
        ...
        <div id="show-estoque" class="content scaffold-show" role="main">
            ...
            <f:display bean="estoque" />
            <g:form resource="${this.estoque}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.estoque}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
