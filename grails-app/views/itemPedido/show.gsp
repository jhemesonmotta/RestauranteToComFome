...
<html>
    ...
    <body>
        ...
        <div id="show-itemPedido" class="content scaffold-show" role="main">
            ...
            <f:display bean="itemPedido" />
            <g:form resource="${this.itemPedido}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.itemPedido}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
