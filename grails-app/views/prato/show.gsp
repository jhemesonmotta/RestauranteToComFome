...
<html>
    ...
    <body>
        ...
        <div id="show-prato" class="content scaffold-show" role="main">
            ...
            <f:display bean="prato" />
            <g:form resource="${this.prato}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.prato}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
