...
<html>
    ...
    <body>
        ...
        <div id="show-sobremesa" class="content scaffold-show" role="main">
            ...
            <f:display bean="sobremesa" />
            <g:form resource="${this.sobremesa}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sobremesa}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
